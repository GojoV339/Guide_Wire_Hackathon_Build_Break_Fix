...
fun PayoutScreen(navController: NavHostController) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Koramangala Heavy Rain Tue 25 Mar 2026",
                fontSize = 13.sp,
                color = GigShieldGray
            )
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    PayoutRow("Hourly rate", "₹87.50")
                    PayoutRow("Coverage rate", "80 percent")
                    PayoutRow("Calculation", "4.0 times ₹87.50 times 80 percent")
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text(
                        "This payout was triggered automatically",
                        fontSize = 13.sp
                    )
                }
            }
