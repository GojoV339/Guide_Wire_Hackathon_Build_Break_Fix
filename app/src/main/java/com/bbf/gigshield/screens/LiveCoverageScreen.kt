        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Spacer(modifier = Modifier.height(4.dp))
                    Text(
                        "Rainfall: 32mm per hour threshold exceeded",
                        fontSize = 13.sp
                    )
                    Text("Duration: 2.5 hours", fontSize = 13.sp)
                    Text(
                        "Payout being calculated",
                        fontSize = 13.sp,
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        "Protected hours remaining: 14 hrs",
                        fontWeight = FontWeight.Bold,
                        fontSize = 14.sp
                    )
                    Spacer(modifier = Modifier.height(8.dp))
            ...
            val activities = listOf(
                "Policy activated — ₹49.00 charged" to "Mon 24 Mar, 12:00 AM",
                "Rain alert triggered in your zone" to "Tue 25 Mar, 2:15 PM",
                "Fraud check passed — Trust score: 0.91" to "Tue 25 Mar, 2:17 PM",
                "Payout processing..." to "Tue 25 Mar, 2:17 PM"
            )

            activities.forEach { (activity, time) ->
                ActivityItem(title = activity, time = time)
            }
